    ...
    <div class="container">
        ...
        <div class="container-fluid">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              ...
              <li><a href="javascript:void(0)" data-toggle="modal" data-target="#createFile"><span class="icon icon-small "><span class="icon-folder"></span></span>新建文件夹</a></li>
              ...
              <li><a href="index.php"><span class="icon icon-small "><span class="icon-arrowLeft"></span></span>返回上级</a></li>
            </ul>
      ...
      <table class="table table-bordered table-hover">
        ...
        <tr>
          ...
          <td>
            <a href="javascript:void(0)" data-url="index.php?act=showContent&fileName=<?php echo $row['name']?>" data-toggle="modal" data-target="#showContent" class="showContentBtn">[ 查看 ]</a>&nbsp;&nbsp;
            <a href="javascript:void(0)" data-filename="<?php echo $row['name']?>" data-url="index.php?act=editContent&fileName=<?php echo $row['name']?>" data-toggle="modal" data-target="#editContent" class="editContentBtn">[ 编辑 ]</a>
